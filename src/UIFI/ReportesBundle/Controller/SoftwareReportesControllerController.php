...
*/
class SoftwareReportesControllerController extends Controller
{
    /**
     * Función que muestra el formulario para filtrar la información relacionada
     * con el software de la facultad.
     *
     * @Route("/reportes/software", name="reportes_software")
     */
    public function indexAction(){
        ...
        $parameters = array('form' => $view, 'ruta'=> 'reportes_software_graficar' );
        return  $this->render('UIFIReportesBundle:SoftwareReportes:index.html.twig',$parameters);
    }
     ...
     *
     * @Route("/reportes/software/graficar",name="reportes_software_graficar")
     * @param Request
     * @return Template
    */
    public function graficarAction(){
        ...
        $ob =  $this->get('uifi.reportes.software')->generarGrafica( $mapParameters );
        $parameters = array( 'chart' => $ob );
        return $this->render('UIFIReportesBundle:SoftwareReportes:reporte.html.twig',$parameters );
    }
}
