 ...
 */
class SoftwareRepository extends EntityRepository implements IReportableRepository
{
    /**
    ...
    */
    ...
    /**
    * Cuenta el número de software publicados por año en la facultad
    *
    */
    public function getCountAllByYear(){
      $em = $this->getEntityManager();
      $connection = $em->getConnection();
      $sql = 'SELECT COUNT(a.anual) AS cantidad, a.anual AS fecha FROM  software a
              GROUP BY a.anual';
      $em = $this->getEntityManager();
    ...
    /**
     * Función que se encarga de contar el número de software que tiene publicado
    ...
    */
    ...
    /**
     * Función que se encarge de contar el número de software que tiene publicado
    ...
    */
    ...
    /**
     * Se obtienen la cantidad de software ppublicados por integrante en un
    ...
    */
    public function getCantidadByIntegrante($code,$idGrupo){
     ...
     /**
      * Función que se encarga de contar la cantidad de software publicados por año
