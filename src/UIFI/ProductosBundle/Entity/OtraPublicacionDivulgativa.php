 ...
 * Libro
 *
 * @ORM\Table("otra_publicacion_divulgativa")
 * @ORM\Entity(repositoryClass="UIFI\ProductosBundle\Repository\OtraPublicacionDivulgativaRepository")
 */
class OtraPublicacionDivulgativa
{
    /**
     * @var integer
     *
    ...
    */
     ...
     *
     * @param string $titulo
     * @return OtraPublicacionDivulgativa
     */
