...
class InnovacionGestionEmpresarialScraper  extends  Scraper
{
    ...
    /**
		...
		* 		$innovacion['institucionFinanciadora'] la institucion financiadora de innovación
		*/
		public function getInnovacionGestionEmpresarial(){
		 $query = '/html/body/table[22]'; 
				 ...
				 foreach($list as $node){
					 ...
					 foreach($valores as $valor) {
							 ...
							 if(strpos($valor,'Institución financiadora')){
						      ...
						      $innovacion['institucionFinanciadora'] = $institucionFinanciadora;
							 }
					 }
				 }
			 }
