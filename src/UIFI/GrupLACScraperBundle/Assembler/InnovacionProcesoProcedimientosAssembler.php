...
use UIFI\ProductosBundle\Entity\InnovacionProcesosProcedimientos;
...
class InnovacionProcesoProcedimientosAssembler{
  ...
  */
  public function crearModelo($innovacionDTO) {
    $innovacion = new InnovacionProcesosProcedimientos();
