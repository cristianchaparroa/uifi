...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'uifi', 'user' => 'root', 'password' => 1032, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c10125af9e8d1a5038055b29cae52b8474536feb865f9f1ec93cb3b9c31b24ad');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('UsersBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('UsersBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('UsersBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('UsersBundle\\Entity\\Usuario');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'UsersBundle\\Entity\\Usuario');
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.usuario'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.usuario'))));
        $instance->setAdminClasses(array('UsersBundle\\Entity\\Usuario' => array(0 => 'sonata.admin.usuario')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.usuario'), $this);
    }
     ...
     *
     * @return \UsersBundle\Admin\UsuarioAdmin A UsersBundle\Admin\UsuarioAdmin instance.
     */
    protected function getSonata_Admin_UsuarioService()
    {
        $instance = new \UsersBundle\Admin\UsuarioAdmin('sonata.admin.usuario', 'UsersBundle\\Entity\\Usuario', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('UsersBundle');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('e08235b1402a3e048e8cb0f652d30759bb2736b8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_name' => 'uifi',
            'database_user' => 'root',
            'database_password' => 1032,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'locale' => 'es',
            'secret' => 'e08235b1402a3e048e8cb0f652d30759bb2736b8',
            ...
            'kernel.secret' => 'e08235b1402a3e048e8cb0f652d30759bb2736b8',
            ...
            'fos_user.model.user.class' => 'UsersBundle\\Entity\\Usuario',
